...
function Nav({ logo }) {
  return (
    ...
    <div>
           <div className="flex flex-wrap justify-between p-6 items-center border-b">
      <div className="flex items-center gap-2">
        <img src={logo} alt="" style={{ height: "30px" }} />
        <Link to="/" className="font-bold text-2xl text-[#ff385c]">olabnb</Link>
      </div>
      <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
        ...
        <div className="border-l border-gray-300"></div>
        <div className="font-semibold text-gray-600">Add guest</div>
      ...
      <div className="flex gap-4 items-center">
        <div className="font-semibold text-gray-800">Airbnb your home</div>
        <div className="flex items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
